...
<div className="bg-white flex flex-col md:flex-row justify-center items-center gap-4 md:gap-16 popout">
  <img src="/imgs/hobart-logo.png" width={300} />
  <img src="/imgs/auckland-2023-logo.png" width={300} />
</div>
