...
* Geochickas ($5,000 + GST) - Sponsor the geochickas networking event, including “supported by” recognition and
...
* Travel Grant Program Breakfast ($4,000 + GST) - Support the travel grant program breakfast for,
...
* Add to the Travel Grant Program Short Distance ($1,500 + GST) - Support someone from nearby with a funds to
...
Get in touch with Alex Leith and Greg Lauer at [sponsorship@foss4g-oceania.org](mailto:sponsorship@foss4g-oceania.org).
