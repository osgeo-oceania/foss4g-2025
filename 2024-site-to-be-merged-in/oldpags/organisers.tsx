...
import OrganisersIntroMD from "../content/organisers-intro.md";
...
I attended the first FOSS4G conference in Melbourne back in 2018 and have attended every year (except 2022 in Fiji) since then.  During COVID I organised the Hobart Hub for 2020 and 2021. I use QGIS software with two volunteer organisations who would not have a mapping capability otherwise.`,
        ...
        <section className="mx-auto mt-8 prose-sm max-w-none">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {organisers.map((organiser) => (
              <div
                key={organiser.name}
                className="p-4 bgbg-slate-50 rounded-lg shadow-md"
              >
